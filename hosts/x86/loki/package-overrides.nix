        ...
        (pkgs.llama-cpp.override {
          ...
          (oldAttrs: rec {
            ...
            src = pkgs.fetchFromGitHub {
              ...
              repo = "llama.cpp";
              tag = "b${version}";
              hash = "sha256-06Sc/vNV6AC47XxWH5eiHr9RDRdwesK7kWTNu6UuS+g=";
              leaveDotGit = true;
              postFetch = ''
      ...
      llama-swap = pkgs.runCommand "llama-swap" { } ''
        ...
        tar -xzf ${
          pkgs.fetchurl {
            ...
            hash = "sha256-On9Z1dy8UY9FE/I1Is6n0ISMLOxNJKXhZM5QVdIo27k=";
          }
        } -C $out/bin
